...
public class SearchUtility {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(binarySearchIterative(intArray, 4));
        System.out.println(binarySearchIterative(intArray, 44));
        System.out.println();
    ...
    // How can we make this generically?
    ...
    // How can we make this with overloading?
    ...
    // How can we make this using iteration?
    ...
    // How can we make this using recursion?
    ...
    private static int binarySearchRecursive(int [] array, int minIndex, int maxIndex, int targetValue) {
        ...
        if (maxIndex >= minIndex) {
            ...
            if (array[mid] == targetValue) {
                ...
                return binarySearchRecursive(array, minIndex, mid -1 + 1, targetValue);
            }
        }
        return -1;
    }
